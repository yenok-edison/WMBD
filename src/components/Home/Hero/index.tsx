...
const Hero = () => {
  ...
  return (
    ...
    <section className="dark:bg-darkmode overflow-hidden pt-36 lg:pt-28">
    
      <div className="container">
        {/* <div className="grid lg:grid-cols-12 grid-cols-1 items-center gap-12 py-16"> */}
        <div className="grid grid-cols-1 lg:grid-cols-12 items-center gap-10 lg:gap-12 py-8 lg:py-16">
          ...
          <div className="col-span-6 flex flex-col gap-0">
            ...
            <h1
              ...
              className="text-3xl sm:text-4xl lg:text-5xl font-bold leading-tight mb-4 text-center lg:text-left"
            >
            ...
            <p
              ...
              className="text-base text-SlateBlueText dark:text-white/70 leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0 text-center lg:text-left"
            >
          ...
          <div
            data-aos="fade-left"
            data-aos-duration="1000"
            className="flex col-span-6 items-center justify-center mt-10 lg:mt-0"
          >
            {/* <div className="relative w-full max-w-[520px] h-[620px] flex items-center justify-center"> */}
            <div className="relative w-full max-w-[520px] h-auto flex items-center justify-center">
              ...
              <div className="relative group">
                ...
                {/* <div className="relative w-[90vw] max-w-[490px] h-[420px] sm:h-[500px] lg:h-[620px] rounded-[24px] lg:rounded-[36px] overflow-hidden border border-white/10 shadow-[0_25px_80px_rgba(0,0,0,0.35)] "> */}
                <div className="relative
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-5 lg:p-8 z-10">
                    ...
                    <h2 className="text-xl lg:text-2xl sm:text-3xl lg:text-4xl font-bold text-white">
                      Arjun Raj Urs
                    </h2>
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mt-4">
                      ...
                      <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl px-2 py-4">
                        <p className="text-xl lg:text-2xl font-bold text-cyan-400">27+</p>
                      ...
                      <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl px-2 py-4">
                        <p className="text-xl lg:text-2xl font-bold text-cyan-400">5,000+</p>
                        <p className="text-xs text-zinc-400 mt-1">
                      ...
                      <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl px-1 py-4">
                        <p className="text-xl lg:text-2xl font-bold text-cyan-400">50,000+</p>
                        <p className="text-xs text-zinc-400 mt-1">
                      ...
                      <div className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl px-2 py-4">
                        <p className="text-xl lg:text-2xl font-bold text-cyan-400">50+</p>
                        <p className="text-xs text-zinc-400 mt-1">
