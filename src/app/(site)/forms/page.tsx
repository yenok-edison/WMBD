    ...
    return (
        <>
            <HeroSub
                ...
                description="OPA is a proprietary diagnostic tool for identifying organisational health. OPA is the brainchild of Arjun Raj Urs that works on a self-assessment algorithm.
